...
def batch_convert_txt_to_npy(seq, base_path):
    ...
    """
    # 输入输出文件夹路径
    input_folder = os.path.join(base_path, seq, 'train', 'Exposure', 'LL0.25', 'exposure_events')
    output_folder = os.path.join(base_path, seq, 'train', 'Exposure', 'LL0.25', 'exposure_events_npy')
